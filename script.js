...
var operationCases = {
  case1: {name: "Weapon Case 1", price: 10.00, img: "https://steamcommunity-a.akamaihd.net/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXU5A1PIYQNqhpOSV-fRPasw8rsRVx4MwFo5_T3eAQ3i6DMIW0X7ojiwoHax6egMOKGxj4G68Nz3-jCp4itjFWx-ktqfSmtcwqVx6sT"},
...
function randSkin() {
     // Force every case to yield a knife (from the 'regular' knife pool).
     try {
         var skinsArray = Object.keys(knives["regular"]);
         var randSkin = skinsArray[Math.floor(Math.random() * skinsArray.length)];
         var identifier = knives["regular"][randSkin];
         var rarity = "covert"; // display as covert / knife rarity
         // encode the inventory entry so the rest of the game can read it
         var toEncode = "knives['regular']" + "['" + randSkin + "']";
         inventory["item" + itemCounter] = window.btoa(toEncode);
         // update counters and UI similar to original logic
         inventoryCurrent += 1;
         itemCounter += 1;
         totalCasesOpened += 1;
         totalKnivesOpened += 1;
         ...
         console.error("randSkin override error:", e);
     }
}
...
var jackpotAI = {
  bot1: ["monkey 1", 1, "https://i.imgur.com/WTjn0MM.png"],
  bot2: ["monkey 2", 1, "https://i.imgur.com/za6Y17z.png"],
  ...
  bot18: ["master gambler", 8, "https://i.imgur.com/ISxQyow.png"],
  bot19: ["monkey king", 9, "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/e5/e51667b64e8591b8428b4fc268fc826f21a982cf_full.jpg"]
};
